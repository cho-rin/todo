...
$MailServer = "smtp.gmail.com"; //SMTP服务器
    $MailPort = 587; //SMTP服务器端口
    $smtpMail = "1118ptest@gmail.com"; //SMTP服务器的用户邮箱
    $smtpuser = "1118ptest@gmail.com"; //SMTP服务器的用户帐号
    $smtppass = "asdf1234a"; //SMTP服务器的用户密码
